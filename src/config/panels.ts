...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  forecast: { name: 'AI Forecasts', enabled: true, priority: 1, ...(_desktop && {  }) }, // trial: unlocked on web, locked on desktop
  ...
  'stock-analysis': { name: 'Stock Analysis', enabled: true, priority: 1,  'locked' as const },
  'stock-backtest': { name: 'Backtesting', enabled: true, priority: 1,  'locked' as const },
  'daily-market-brief': { name: 'Daily Market Brief', enabled: true, priority: 1,  'locked' as const },
  'chat-analyst': { name: 'WM Analyst', enabled: true, priority: 1,  'locked' as const },
  economic: { name: 'Macro Stress', enabled: true, priority: 1 },
  'trade-policy': { name: 'Trade Policy', enabled: true, priority: 1,  'locked' as const },
  'supply-chain': { name: 'Supply Chain', enabled: true, priority: 1, ...(_desktop && {  }) },
  ...
  'oref-sirens': { name: 'Israel Sirens', enabled: true, priority: 2, ...(_desktop && {  }) },
  'telegram-intel': { name: 'Telegram Intel', enabled: true, priority: 2, ...(_desktop && {  }) },
